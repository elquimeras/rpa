...
WinWaitActive("[CLASS:ApplicationFrameWindow]", "Calculadora")
...
WinClose("[CLASS:ApplicationFrameWindow]", "Calculadora")

; Now wait for the calculator to close before continuing
WinWaitClose("[CLASS:ApplicationFrameWindow]", "Calculadora")
